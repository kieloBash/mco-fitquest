...
class MyActivitiesAdapter(private val data: ArrayList<Activity>): RecyclerView.Adapter<MyActivitiesViewHolder>() {
    ...
    * */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyActivitiesViewHolder {
        ...
        val view = inflater.inflate(R.layout.my_activities_item, parent, false)
